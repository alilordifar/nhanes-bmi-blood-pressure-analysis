...
ggplot(df_plot, aes(x = bmi, y = bp, color = age_group)) +
  ...
  labs(
    ...
    subtitle = "Smoothed trends highlight how the relationship varies across age groups",
...
Finally, we considered whether the relationship between BMI and blood pressure may differ across people of different ages. To examine this possibility, we included an interaction term between BMI and age. This allows the effect of BMI on systolic blood pressure to vary depending on age, rather than assuming that BMI has the same effect for everyone. This specification provides a more flexible way to describe the relationship and helps us test whether age changes the strength of the association between BMI and blood pressure.
...
```{r report models, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
stargazer(
  model_one,
  model_two,
  model_three,
  ...
  type = "latex",
  covariate.labels = c("BMI", "BMI Squared", "Age", "Smoking", "BMI x Age"),
  digits = 2,
  omit.stat = c('ser', 'f'),
